...
export const DEFAULTS_TEST_TABLE = {
  test_timestamp: {
    type: "timestamp",
    input: new Date("2024-01-01T00:00Z"),
    output_pg: new Date("2024-01-01T00:00Z"),
    output_pglite: new Date("2023-12-31T22:00:00Z"),
    output_postgres: new Date("2023-12-31T22:00:00Z"),
  },
  test_timestamp_iso: {
    type: "timestamp",
    ...
    output_pglite: new Date("2023-12-31T22:00:00Z"),
    output_postgres: new Date("2023-12-31T20:00Z"),
  },
  test_timestamp_tz: {
    type: "timestamptz",
    input: new Date("2024-01-01T00:00Z"),
    output_pg: new Date("2024-01-01T00:00Z"),
    output_pglite: new Date("2024-01-01T00:00Z"),
    output_postgres: new Date("2024-01-01T00:00Z"),
  },
  test_timestamp_tz_iso: {
    type: "timestamptz",
    input: "2024-01-01 00:00:00",
    output_pg: new Date("2024-01-01T00:00:00Z"),
    output_pglite: new Date("2023-12-31T22:00:00Z"),
    output_postgres: new Date("2023-12-31T22:00:00Z"),
  },
  test_date: {
